...
class BuyMixin:
    ...
    def should_buy(self, symbol: str, analysis: dict,
        ...
        mtf_points     = (core_votes.get('multitimeframe',  0) / 100) * 5
        fib_points     = (core_votes.get('fibonacci',       0) / 100) * 4
        whale_points   = (core_votes.get('smart_money',     0) / 100) * 2
        volume_points  = (core_votes.get('volume_forecast', 0) / 100) * 1
        pattern_points = (core_votes.get('pattern',         0) / 100) * 6
