...
class HybridStorage:
    ...
    def load_patterns(self):
        return self._load_prefer_db(
            self.database.load_patterns if self.db_available and self.database else lambda: [],
    ...
    def save_positions(self, positions):
        return self._save_both(
            self.database.save_positions if self.db_available and self.database else lambda x: False,
