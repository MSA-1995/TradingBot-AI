...
class DatabaseStorage:
    ...
    def _initialize_tables_background(self):
        ...
        print("✅ Background table verification complete.")
        ...
        try:
            ...
            sql_upsert = """
                ...
                ON CONFLICT (symbol) DO UPDATE SET
                    ...
                    data = EXCLUDED.data;
            """
            execute_batch(cursor, sql_upsert, positions_data)

            # 2. DELETE any positions from the DB that are no longer in the live batch.
            # This handles sells/closed positions.
            symbols_in_batch = tuple(pos['symbol'] for pos in positions_data)
