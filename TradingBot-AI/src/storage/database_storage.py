    ...
    def save_trade(self, trade_data):
        ...
        try:
            ...
            """, (
                ...
                trade_data.get('whale_confidence') or trade_data.get('whale_activity', 0),
                trade_data.get('atr_value') if trade_data.get('atr_value') else trade_data.get('atr', 0),
                trade_data.get('sentiment_score', 0),
                trade_data.get('panic_score') if trade_data.get('panic_score') else (trade_data.get('panic_greed') or {}).get('panic_score', 0),
                trade_data.get('optimism_penalty') if trade_data.get('optimism_penalty') else (
                    min((trade_data.get('profit_percent', 0) or 0) * 0.1, 5.0)
                    if (trade_data.get('profit_percent', 0) or 0) > 0 else 0.0
                ),
        ...
        try:
            ...
            cursor.execute("""
                INSERT INTO symbol_memory (
                    ...
                    win_count, total_trades, avg_profit, trap_count
            ...
            """, (
                ...
                data.get('avg_profit', 0.0),
                data.get('trap_count', 0)
            ))
            conn.commit()
            cursor.close()
            return True
