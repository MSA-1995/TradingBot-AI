...
class Meta:
    def __init__(self, advisor_manager=None, storage=None):
        print(f"[DIAGNOSTIC] meta.py: Initializing Meta instance with ID: {id(self)}")
        print(f"[DIAGNOSTIC] meta.py: Received advisor_manager with ID: {id(advisor_manager) if advisor_manager else 'None'}")
