...
class Meta:
    ...
    def should_buy(self, symbol, analysis, models_scores=None, candles=None, preloaded_advisors=None):
        ...
        try:
            ...
            try:
                ...
                print(f"⚠️ Candle Expert error: {e}")
                candle_expert_score = 50
            
            # دمج pattern_confidence من reversal + candle_expert
            advisors_intelligence['pattern_confidence'] = base_pattern_confidence
        ...
        total_intelligence = (
            ...
            candle_expert_score * 0.08 +       # 8% أنماط الشموع 
        ...
        # print(f"   Others (10%):        {((sentiment_score + 10) * 0.04 + liquidity_score * 0.03 + (news_impact + 15) * 0.02 + macro_trend * 0.01):.1f}")
        # print(f"   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    ...
    def _calculate_smart_amount(self, symbol, confidence, analysis):
        ...
        try:
            # استثمار أكبر للموجات الطويلة: 3000$ / 5 عملات = 600$ لكل صفقة
            base_amount = 600.0 
            confidence_factor = (confidence - 85) / 15.0  # الحساب من حد الثقة الجديد 85
