...
print("[DIAGNOSTIC] trading_bot.py: Creating AdvisorManager...")
advisor_manager = AdvisorManager(storage=storage, capital_manager=capital_manager, exchange=exchange, dl_client=dl_client)
print(f"[DIAGNOSTIC] trading_bot.py: AdvisorManager created with ID: {id(advisor_manager)}")
...
if META_ENABLED:
    ...
    print("[DIAGNOSTIC] trading_bot.py: Creating Meta...")
    meta = META_CLASS(advisor_manager, storage)
    print(f"[DIAGNOSTIC] trading_bot.py: Meta created with ID: {id(meta)}")
    print(f"[DIAGNOSTIC] trading_bot.py: Meta's advisor_manager has ID: {id(meta.advisor_manager) if meta.advisor_manager else 'None'}")
