...
if MODELS_ENABLED:
    print(f"🧠 12 LightGBM Models: ACTIVE (Trained on 16K+ Trades)")
...
print("🧠 AI Models: 12 LightGBM + 5 Elite Advisors (17 Total)")
