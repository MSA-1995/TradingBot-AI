...
if MODELS_ENABLED:
    ...
    print(f"   ├─ Exit Strategy (Peak/Valley Hold)")
...
print(f"🎯 TP: Peak/Valley Catcher (50-80%) | SL: ATR Adaptive")
...
print("🚀 Features: Shadow Alpha, Liquidity Sweep, Peak/Valley Catcher")
