...
def get_market_analysis(exchange, symbol, limit=120, external_client=None):
    ...
    try:
        ...
        # ✅ استخدم df الموجود بدل إعادة البناء
        candles_5m = df.tail(20).to_dict('records')
        ...
        try:
            ...
            print(f"⚠️ bid_ask_spread error: {e}")
            bid_ask_spread = 0
        ...
        try:
            ...
            print(f"⚠️ Average spread error: {e}")
