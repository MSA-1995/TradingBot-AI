    ...
    def _load_all_models_from_db(self):
        ...
        for name in model_names:
            try:
                ...
                if not result or not result.get('model_data'):
                    continue
                ...
                # ✅ FIX: LightGBM pickle load from memory bug fix
                import tempfile
                model = None
                
                # Try 1: Decompress gzip data
                try:
                ...
                print(f"  ❌ {name}: Unexpected error - {str(e)[:60]}")
