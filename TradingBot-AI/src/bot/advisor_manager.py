...
class AdvisorManager:
    ...
    def __init__(self, storage, capital_manager, exchange=None, dl_client=None):
        ...
        self._creators = {
            'DeepLearningClientV2': lambda: __import__('dl_client_v2', fromlist=['DeepLearningClientV2']).DeepLearningClientV2(database_url=os.getenv('DATABASE_URL')) if os.getenv('DATABASE_URL') else None,
            'dl_client':            lambda: __import__('dl_client_v2', fromlist=['DeepLearningClientV2']).DeepLearningClientV2(database_url=os.getenv('DATABASE_URL')) if os.getenv('DATABASE_URL') else None,
