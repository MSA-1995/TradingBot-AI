...
class AdvisorsMixin:
    ...
    def _run_sell_core_voting(self, symbol: str,
        ...
        # 2️⃣ chart_cnn
        try:
            votes['chart_cnn'] = analysis.get('chart_cnn_score', 0)
        except Exception as e:
        ...
        try:
            ...
            whale_score = analysis.get('whale_score', 0)
            votes['smart_money'] = (
                100 if whale_dump
                else whale_score)
        except Exception as e:
    ...
    def _get_candle_score(self, analysis_data: dict,
        ...
        try:
            ...
            if action == 'BUY':
                ...
                if 'Strong-Bullish' in text: return self.CANDLE_SCORE_STRONG_BEAR
                if 'Bullish'        in text: return self.CANDLE_SCORE_BEAR
