...
MIN_CONFIDENCE = 40  # الحد الأدنى للشراء (50/110)
MIN_SELL_CONFIDENCE = 40  # الحد الأدنى للبيع (55/110) - متوازن بين الصبر والسرعة
...
VOLUME_SPIKE_FACTOR = 0.2 # Multiplier for detecting significant volume spikes (lowered for more opportunities)
PEAK_DROP_THRESHOLD = 0.5   # % هبوط من القمة يعتبر إشارة بيع (Dynamic Trailing Stop-Loss)
BOTTOM_BOUNCE_THRESHOLD = 0.5  # % ارتداد من القاع يعتبر إشارة شراء (0.5% = وسط)
